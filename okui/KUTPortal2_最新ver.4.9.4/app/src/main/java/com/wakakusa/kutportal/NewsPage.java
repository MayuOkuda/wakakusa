...
public class NewsPage extends BasePage {
    ...
    private  void setNews() {
        ...
        npop[1].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[0].substring(0,4)+"/"+s3[0].substring(4,6)+"/"+s3[0].substring(6,8))
                        .setMessage(s3[1] + "\n" + "送信者　" + s3[2] + "\n" + s3[3] + "\n" + s3[4])
        ...
        npop[2].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[6].substring(0,4)+"/"+s3[6].substring(4,6)+"/"+s3[6].substring(6,8))
                        .setMessage(s3[7] + "\n" + "送信者　" + s3[8] + "\n" + s3[9] + "\n" + s3[10])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[3].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[12].substring(0,4)+"/"+s3[12].substring(4,6)+"/"+s3[12].substring(6,8))
                        .setMessage(s3[13] + "\n" + "送信者　" + s3[14] + "\n" + s3[15] + "\n" + s3[16])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[4].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[18].substring(0,4)+"/"+s3[18].substring(4,6)+"/"+s3[18].substring(6,8))
                        .setMessage(s3[19] + "\n" + "送信者　" + s3[20] + "\n" + s3[21] + "\n" + s3[22])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[5].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[24].substring(0,4)+"/"+s3[24].substring(4,6)+"/"+s3[24].substring(6,8))
                        .setMessage(s3[25] + "\n" + "送信者　" + s3[26] + "\n" + s3[27] + "\n" + s3[28])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[6].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[30].substring(0,4)+"/"+s3[30].substring(4,6)+"/"+s3[30].substring(6,8))
                        .setMessage(s3[31] + "\n" + "送信者　" + s3[32] + "\n" + s3[33] + "\n" + s3[34])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[7].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[36].substring(0,4)+"/"+s3[36].substring(4,6)+"/"+s3[36].substring(6,8))
                        .setMessage(s3[37] + "\n" + "送信者　" + s3[38] + "\n" + s3[39] + "\n" + s3[40])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[8].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[42].substring(0,4)+"/"+s3[42].substring(4,6)+"/"+s3[42].substring(6,8))
                        .setMessage(s3[43] + "\n" + "送信者　" + s3[44] + "\n" + s3[45] + "\n" + s3[46])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[9].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[48].substring(0,4)+"/"+s3[48].substring(4,6)+"/"+s3[48].substring(6,8))
                        .setMessage(s3[49] + "\n" + "送信者　" + s3[50] + "\n" + s3[51] + "\n" + s3[52])
                        .setPositiveButton("OK", null)
                        .show();
            }
        ...
        npop[10].setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(NewsPage.this)
                        .setTitle(s3[54].substring(0,4)+"/"+s3[54].substring(4,6)+"/"+s3[54].substring(6,8))
                        .setMessage(s3[55] + "\n" + "送信者　" + s3[56] + "\n" + s3[57] + "\n" + s3[58])
                        .setPositiveButton("OK", null)
                        .show();
            }
    ...
    String getS2(){
        ...
        if(item.equals("すべて")) s = rd.readDB2au(str,"",new String[]{}); //データベースから読み出し
