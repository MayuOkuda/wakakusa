...
public class ScorePage extends BasePage{
    ...
    public void scoresjc(){
        ...
        String[] strcs2 = {"course"};
        String[] cs =  dbReader.readDB3(strcs, "course.sj=?" , new String[]{"人文・社会科学等科目"},"course").split("\n");
        String[] cs2 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"自然科学等科目"},"course").split("\n");
        String[] cs3 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"情報学群専門科目"},"course").split("\n");
        String[] cs4 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"工業系共通科目"},"course").split("\n");
        String[] cs5 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"専門基礎科目"},"course").split("\n");
        String[] cs6 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"専門発展科目"},"course").split("\n");
        String[] cs7 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"選考領域科目"},"course").split("\n");
        String[] cs8 = dbReader.readDB3(strcs, "course.sj=?" , new String[]{"他学群・他学部専門科目"},"course").split("\n");
    ...
    public void scorecount() {
        ...
        //期間GPA 1Q
        String[] str = {"score"};
        String[] s11 = dbReader.readDB2(str, "year=? AND period=?", new String[]{ymd, "1Q"}).split("\n");
        int f11 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s12 = dbReader.readDB2(str, "year=? AND period=? ", new String[]{ymd, "2Q"}).split("\n");
        int f12 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s13 = dbReader.readDB2(str, "year=? AND period=?", new String[]{ymd, "3Q"}).split("\n");
        int f13 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s14 = dbReader.readDB2(str, "year=? AND period=? ", new String[]{ymd, "4Q"}).split("\n");
        int f14 = 0;
        ...
        totald = 0;
        String[] str2 = {"score"};
        String[] s21 = dbReader.readDB2(str2, "year=? AND period=?", new String[]{ymd2, "1Q"}).split("\n");
        int f21 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s22 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{ymd2, "2Q"}).split("\n");
        int f22 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s23 = dbReader.readDB2(str2, "year=? AND period=?", new String[]{ymd2, "3Q"}).split("\n");
        int f23 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s24 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{ymd2, "4Q"}).split("\n");
        int f24 = 0;
        ...
        totald = 0;
        String[] str3 = {"score"};
        String[] s31 = dbReader.readDB2(str3, "year=? AND period=?", new String[]{ymd3, "1Q"}).split("\n");
        int f31 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s32 = dbReader.readDB2(str3, "year=? AND period=? ", new String[]{ymd3, "2Q"}).split("\n");
        int f32 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s33 = dbReader.readDB2(str3, "year=? AND period=?", new String[]{ymd3, "3Q"}).split("\n");
        int f33 = 0;
        ...
        total += totalsub;
        totalsub = 0;
        String[] s34 = dbReader.readDB2(str3, "year=? AND period=? ", new String[]{ymd3, "4Q"}).split("\n");
        int f34 = 0;
    ...
    public void scoreapp() {
        ...
        //期間GPA 2Q
        String[] str2 = {"score"};
        String[] s2 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{item, "2Q"}).split("\n");
        ...
        //期間GPA 4Q
        String[] str4 = {"score"};
        String[] s4 = dbReader.readDB2(str4, "year=? AND period=?", new String[]{item, "4Q"}).split("\n");
        ...
        if(year == ymds || year == ymdt) {
            ...
            //期間GPA 2Q
            String[] str2_2 = {"score"};
            String[] s2_2 = dbReader.readDB2(str2_2, "year=? AND period=? ", new String[]{item, "2Q"}).split("\n");
            ...
            //期間GPA 4Q
            String[] str4_2 = {"score"};
            String[] s4_2 = dbReader.readDB2(str4_2, "year=? AND period=?", new String[]{item, "4Q"}).split("\n");
        ...
        if(year == ymdt) {
            ...
            //期間GPA 2Q
            String[] str2_3 = {"score"};
            String[] s2_3 = dbReader.readDB2(str2_3, "year=? AND period=? ", new String[]{item, "2Q"}).split("\n");
            ...
            //期間GPA 4Q
            String[] str4_3 = {"score"};
            String[] s4_3 = dbReader.readDB2(str4_3, "year=? AND period=?", new String[]{item, "4Q"}).split("\n");
