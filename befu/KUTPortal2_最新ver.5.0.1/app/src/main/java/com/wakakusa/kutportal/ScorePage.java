...
public class ScorePage extends BasePage {
    ...
    void pop() {
        onClick_textview[0] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclass=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclass", "subject", "sj", "score"}, sjcl, new String[]{"人文・社会科学等科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
            }
        };
        ...
        onClick_textview[1] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclass=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclass", "subject", "sj", "score"}, sjcl, new String[]{"自然科学等科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[2] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclass=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclass", "subject", "sj", "score"}, sjcl, new String[]{"専門科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[3] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclasssub=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclasssub", "subject", "sj", "score"}, sjcl, new String[]{"工学系共通科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[4] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclasssub=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclasssub", "subject", "sj", "score"}, sjcl, new String[]{"専門基礎科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[5] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclasssub=? AND course.scode = score.scode AND score.score !=? AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclasssub", "subject", "sj", "score"}, sjcl, new String[]{"専門発展科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[6] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclasssub=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclasssub", "subject", "sj", "score"}, sjcl, new String[]{"専攻領域科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[7] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.sjclasssub=? AND course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclasssub", "subject", "sj", "score"}, sjcl, new String[]{"他学群・他学部専門科目",""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    ClassDialog(msg);
                }
        ...
        onClick_textview[8] = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReader dbReader = new DatabaseReader(getBaseContext(), "course");
                String sjcl = "course.scode = score.scode AND score.score !=?";
                String[] cs = dbReader.readDB3(new String[]{"sjclass", "subject", "sj", "score"}, sjcl, new String[]{""}, "course, score").split("\n");
                if (cs[0] != "") {
                    String msg[] = structMessage(cs);
                    msg[0]="総合計";
                    ClassDialog(msg);
    ...
    int p = 0;
        for (int i = 0; i < 9; i++) {
            TextView text = (TextView) findViewById(ID[i]);
    ...
    String[] structMessage(String[] str){
        String[] message = new String[2];
        message[0] = str[0];
        message[1] = "科目名 : 単位数　/　成績　 \n" + "-------------------------------\n";

        for(String s : str)System.out.println(s);
        for(int i = 0; i+3 < str.length ; i+=4){
            message[1] += str[i+1].split("\n",0)[0] + " : ";
            message[1] += str[i+2].split("\n",0)[0] + " / ";
            if(str[i+3]==null)str[i+3]="";
            message[1] += str[i+3].split("\n",0)[0] + "\n";
        }
