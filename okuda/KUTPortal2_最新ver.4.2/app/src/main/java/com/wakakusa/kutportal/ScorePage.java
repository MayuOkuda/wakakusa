...
public class ScorePage extends BasePage{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ScorePage.this, "成績明細を表示します", Toast.LENGTH_LONG).show();
                //ScoreSpecification();
            }
        });
        ...
        cvalue3.put("period", "1"); //科目時期(Q指定)
        cvalue3.put("sj", "1"); //単位数
        cvalue3.put("sjclass","人文・社会科学等科目"); //単位区分(科目別)
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);

        cvalue3.put("scode", "1122");
        cvalue3.put("period", "1");
        cvalue3.put("sj", "1");
        cvalue3.put("sjclass","自然科学等科目");
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);

        cvalue3.put("scode", "1243");
        cvalue3.put("period", "2");
        cvalue3.put("sj", "4");
        cvalue3.put("sjclass","情報学群専門科目");
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);

        cvalue3.put("scode", "1324");
        cvalue3.put("period", "3");
        cvalue3.put("sj", "2");
        cvalue3.put("sjclass","工業系共通科目");
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);

        cvalue3.put("scode", "155");
        cvalue3.put("period", "4");
        cvalue3.put("sj", "5");
        cvalue3.put("sjclass","専門基礎科目");
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);

        cvalue3.put("scode", "1436");
        cvalue3.put("period", "4");
        cvalue3.put("sj", "3");
        cvalue3.put("sjclass","専門発展科目");
        dbWriter3.write.insert(dbWriter3.Table_name, null, cvalue3);
    ...
    public void scoresjc(){
        ...
        String[] strcs = {"course"};
        String[] cs = dbReader.readDB2(strcs, "sjclass=?", new String[]{"人文・社会科学等科目"}).split("\n");
        String[] cs2 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"自然科学等科目"}).split("\n");
        String[] cs3 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"情報学群専門科目"}).split("\n");
        String[] cs4 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"工業系共通科目"}).split("\n");
        String[] cs5 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"専門基礎科目"}).split("\n");
        String[] cs6 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"専門発展科目"}).split("\n");
        String[] cs7 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"選考領域科目"}).split("\n");
        String[] cs8 = dbReader.readDB2(strcs, "sjclass=?", new String[]{"他学群・他学部専門科目"}).split("\n");
        ...
        if (total != 0) csvtotal.setText(total);
    ...
    public void scorecount() {
        ...
        String ymd = dbReader2.readDB(new String[]{"adm"}, 0).substring(0, 4);
        int ymds = Integer.parseInt(ymd);
        ymds++;
        String ymd2 = String.valueOf(ymds);
        int ymdt = Integer.parseInt(ymd2);
        ymdt++;
        String ymd3 = String.valueOf(ymdt);
        item = item.substring(0,4);
        year = Integer.valueOf(item);

        TextView scv = (TextView) findViewById(R.id.sjctotal);
        TextView scv2 = (TextView) findViewById(R.id.sjc);
        TextView scv3 = (TextView) findViewById(R.id.sjc2);
        TextView scv4 = (TextView) findViewById(R.id.sjtotal);
        TextView scv5 = (TextView) findViewById(R.id.sj);
        TextView scv6 = (TextView) findViewById(R.id.sj2);
        scv.setText("");
        scv2.setText("");
        scv3.setText("");
        scv4.setText("");
        ...
        //期間GPA 1Q
        String[] str = {"score"};
        String[] s11 = dbReader.readDB2(str, "year=? AND period=?", new String[]{ymd, "1"}).split("\n");
        int f11 = 0;
        if(s11 != null) f11 = fcheck(s11);
        totalcu += f11;
        totalc += f11;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s12 = dbReader.readDB2(str, "year=? AND period=? ", new String[]{ymd, "2"}).split("\n");
        int f12 = 0;
        if(s12 != null) f12 = fcheck(s12);
        totalcu += f12;
        totalc += f12;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s13 = dbReader.readDB2(str, "year=? AND period=?", new String[]{ymd, "3"}).split("\n");
        int f13 = 0;
        if(s13 != null) f13 = fcheck(s13);
        totalcd += f13;
        totalc += f13;
        totald += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s14 = dbReader.readDB2(str, "year=? AND period=? ", new String[]{ymd, "4"}).split("\n");
        int f14 = 0;
        if(s14 != null) f14 = fcheck(s14);
        totalcd += f14;
        totalc += f14;
        totald += totalsub;
        total += totalsub;
        ...
        totald = 0;
        String[] str2 = {"score"};
        String[] s21 = dbReader.readDB2(str2, "year=? AND period=?", new String[]{ymd2, "1"}).split("\n");
        int f21 = 0;
        if(s21 != null) f21 = fcheck(s21);
        totalcu += f21;
        totalc += f21;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s22 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{ymd2, "2"}).split("\n");
        int f22 = 0;
        if(s22 != null) f22 = fcheck(s22);
        totalcu += f22;
        totalc += f22;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s23 = dbReader.readDB2(str2, "year=? AND period=?", new String[]{ymd2, "3"}).split("\n");
        int f23 = 0;
        if(s23 != null) f23 = fcheck(s23);
        totalcd += f23;
        totalc += f23;
        totald += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s24 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{ymd2, "4"}).split("\n");
        int f24 = 0;
        if(s24 != null) f24 = fcheck(s24);
        totalcd += f24;
        totalc += f24;
        totald += totalsub;
        total += totalsub;
        ...
        totald = 0;
        String[] str3 = {"score"};
        String[] s31 = dbReader.readDB2(str3, "year=? AND period=?", new String[]{ymd3, "1"}).split("\n");
        int f31 = 0;
        if(s31 != null) f31 = fcheck(s31);
        totalcu += f31;
        totalc += f31;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s32 = dbReader.readDB2(str3, "year=? AND period=? ", new String[]{ymd3, "2"}).split("\n");
        int f32 = 0;
        if(s32 != null) f32 = fcheck(s32);
        totalcu += f32;
        totalc += f32;
        totalu += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s33 = dbReader.readDB2(str3, "year=? AND period=?", new String[]{ymd3, "3"}).split("\n");
        int f33 = 0;
        if(s33 != null) f33 = fcheck(s33);
        totalcd += f33;
        totalc += f33;
        totald += totalsub;
        total += totalsub;
        totalsub = 0;
        String[] s34 = dbReader.readDB2(str3, "year=? AND period=? ", new String[]{ymd3, "4"}).split("\n");
        int f34 = 0;
        if(s34 != null) f34 = fcheck(s34);
        totalcd += f34;
        totalc += f34;
        totald += totalsub;
        total += totalsub;
    ...
    public void scoreapp() {
        ...
        //System.out.println("Hello!" + item + ymd3);
        item = item.substring(0,4);

        //1年目
        //期間GPA 1Q
        String[] str = {"score"};
        String[] s = dbReader.readDB2(str, "year=? AND period=?", new String[]{item, "1"}).split("\n");
        ...
        //期間GPA 2Q
        String[] str2 = {"score"};
        String[] s2 = dbReader.readDB2(str2, "year=? AND period=? ", new String[]{item, "2"}).split("\n");
        ...
        //期間GPA 3Q
        String[] str3 = {"score"};
        String[] s3 = dbReader.readDB2(str3, "year=? AND period=?", new String[]{item, "3"}).split("\n");
        ...
        //期間GPA 4Q
        String[] str4 = {"score"};
        String[] s4 = dbReader.readDB2(str4, "year=? AND period=?", new String[]{item, "4"}).split("\n");
        ...
        //2年目
        //期間GPA 1Q
        if(item == ymd2 || item == ymd3) {
            System.out.println(item);
            String[] str_2 = {"score"};
            String[] s_2 = dbReader.readDB2(str_2, "year=? AND period=?", new String[]{item, "1"}).split("\n");
            ...
            //期間GPA 2Q
            String[] str2_2 = {"score"};
            String[] s2_2 = dbReader.readDB2(str2_2, "year=? AND period=? ", new String[]{item, "2"}).split("\n");
            ...
            //期間GPA 3Q
            String[] str3_2 = {"score"};
            String[] s3_2 = dbReader.readDB2(str3_2, "year=? AND period=?", new String[]{item, "3"}).split("\n");
            ...
            //期間GPA 4Q
            String[] str4_2 = {"score"};
            String[] s4_2 = dbReader.readDB2(str4_2, "year=? AND period=?", new String[]{item, "4"}).split("\n");
        ...
        if(item == ymd3) {
            String[] str_3 = {"score"};
            String[] s_3 = dbReader.readDB2(str_3, "year=? AND period=?", new String[]{item, "1"}).split("\n");
            ...
            //期間GPA 2Q
            String[] str2_3 = {"score"};
            String[] s2_3 = dbReader.readDB2(str2_3, "year=? AND period=? ", new String[]{item, "2"}).split("\n");
            ...
            //期間GPA 3Q
            String[] str3_3 = {"score"};
            String[] s3_3 = dbReader.readDB2(str3_3, "year=? AND period=?", new String[]{item, "3"}).split("\n");
            ...
            //期間GPA 4Q
            String[] str4_3 = {"score"};
            String[] s4_3 = dbReader.readDB2(str4_3, "year=? AND period=?", new String[]{item, "4"}).split("\n");
    ...
    public double  Changescore(String[] s){
        ...
        i2 = i2.setScale(1, BigDecimal.ROUND_HALF_UP);
        i = i2.doubleValue();
    ...
    public double TotalSum(){
        ...
        s2 = s2.setScale(1, BigDecimal.ROUND_HALF_UP);
        s = s2.doubleValue();
        return s;
    }


    public void ScoreSpecification(){
        DatabaseReader dbReader = new DatabaseReader(this, "course");
        String[] strcs = {"course"};
        String[] cs = dbReader.readDB2(strcs, "sjclass=?", new String[]{"人文・社会科学等科目"}).split("\n");

       // TableLayout tableLayout = (TableLayout)findViewById(R.id.addtableLayout);
