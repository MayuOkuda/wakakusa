...
class DatabaseWriter {
    ...
    final String[] sessionID_property = {"sessionID","time","ara"};
    ...
    public DatabaseWriter(Context context, String table) {
        ...
        else if(Table_name.equals(tableName[5])) property = sessionID_property;
    }
    ...
    public void LoginWrite(String str1, String str2) {
        ContentValues cvalue = new ContentValues();
        for(String i:property) {
            cvalue.put(i,str2);
        System.out.println(cvalue);
        }
        //cvalue.put("time","2016/12/01");
        //cvalue.put("ara","ra");
        write.insert(this.Table_name, null, cvalue);
...
class DatabaseReader {
    ...
    public DatabaseReader(String table) {
        Table_name = table;
        read = DatabaseWriter.helper.getWritableDatabase();
    }
